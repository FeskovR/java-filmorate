...
--CREATE TABLE IF NOT EXISTS unconfirmed_friends (
--    user_id int   NOT NULL,
--    friend_request_id int   NOT NULL,
--    CONSTRAINT pk_unconfirmed_friends PRIMARY KEY (user_id),
--    CONSTRAINT fk_unconfirmed_friends_user_id FOREIGN KEY(user_id) REFERENCES users (user_id),
--    CONSTRAINT fk_unconfirmed_friends_friend_request_id FOREIGN KEY(friend_request_id) REFERENCES users (user_id)
--);
--
--CREATE TABLE IF NOT EXISTS confirmed_friends (
--    user_id int   NOT NULL,
--    friend_id int   NOT NULL,
--    CONSTRAINT pk_confirmed_friends PRIMARY KEY (user_id),
--    CONSTRAINT fk_confirmed_friends_user_id FOREIGN KEY(user_id) REFERENCES users (user_id),
--    CONSTRAINT fk_confirmed_friends_friend_id FOREIGN KEY(friend_id) REFERENCES users (user_id)
--);